...
_global_ void init_arrays(int *Delta, int *unsat, int *fixThre, int g_MAX_INDEX_OF_NODE, Edge *V, int *sumnd)
{
    _shared_ int shared_Delta[256];
    _shared_ int shared_unsat[256];
    _shared_ int shared_fixThre[256];
